...
public class LuckyBoxMenu extends AbstractContainerMenu {
    ...
    public LuckyBoxMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.LUCKY_BOX.get());
    }
