...
public enum BlocksEnum {
    ...
    WHITE_BED(Blocks.WHITE_BED),
    ORANGE_BED(Blocks.ORANGE_BED),
    MAGENTA_BED(Blocks.MAGENTA_BED),
    LIGHT_BLUE_BED(Blocks.LIGHT_BLUE_BED),
    YELLOW_BED(Blocks.YELLOW_BED),
    LIME_BED(Blocks.LIME_BED),
    PINK_BED(Blocks.PINK_BED),
    GRAY_BED(Blocks.GRAY_BED),
    LIGHT_GRAY_BED(Blocks.LIGHT_GRAY_BED),
    CYAN_BED(Blocks.CYAN_BED),
    PURPLE_BED(Blocks.PURPLE_BED),
    BLUE_BED(Blocks.BLUE_BED),
    BROWN_BED(Blocks.BROWN_BED),
    GREEN_BED(Blocks.GREEN_BED),
    RED_BED(Blocks.RED_BED),
    BLACK_BED(Blocks.BLACK_BED),
    ...
    PISTON_HEAD(Blocks.PISTON_HEAD),
    ...
    MOVING_PISTON(Blocks.MOVING_PISTON),
    ...
    CHISELED_BOOKSHELF(Blocks.CHISELED_BOOKSHELF),
    MOSSY_COBBLESTONE(Blocks.MOSSY_COBBLESTONE),
    OBSIDIAN(Blocks.OBSIDIAN),
    TORCH(Blocks.TORCH),
    WALL_TORCH(Blocks.WALL_TORCH),
    FIRE(Blocks.FIRE),
    SOUL_FIRE(Blocks.SOUL_FIRE),
    ...
    OAK_SIGN(Blocks.OAK_SIGN),
    SPRUCE_SIGN(Blocks.SPRUCE_SIGN),
    BIRCH_SIGN(Blocks.BIRCH_SIGN),
    ACACIA_SIGN(Blocks.ACACIA_SIGN),
    CHERRY_SIGN(Blocks.CHERRY_SIGN),
    JUNGLE_SIGN(Blocks.JUNGLE_SIGN),
    DARK_OAK_SIGN(Blocks.DARK_OAK_SIGN),
    MANGROVE_SIGN(Blocks.MANGROVE_SIGN),
    BAMBOO_SIGN(Blocks.BAMBOO_SIGN),
    OAK_DOOR(Blocks.OAK_DOOR),
    LADDER(Blocks.LADDER),
    RAIL(Blocks.RAIL),
    COBBLESTONE_STAIRS(Blocks.COBBLESTONE_STAIRS),
    OAK_WALL_SIGN(Blocks.OAK_WALL_SIGN),
    SPRUCE_WALL_SIGN(Blocks.SPRUCE_WALL_SIGN),
    BIRCH_WALL_SIGN(Blocks.BIRCH_WALL_SIGN),
    ACACIA_WALL_SIGN(Blocks.ACACIA_WALL_SIGN),
    CHERRY_WALL_SIGN(Blocks.CHERRY_WALL_SIGN),
    JUNGLE_WALL_SIGN(Blocks.JUNGLE_WALL_SIGN),
    DARK_OAK_WALL_SIGN(Blocks.DARK_OAK_WALL_SIGN),
    MANGROVE_WALL_SIGN(Blocks.MANGROVE_WALL_SIGN),
    BAMBOO_WALL_SIGN(Blocks.BAMBOO_WALL_SIGN),
    OAK_HANGING_SIGN(Blocks.OAK_HANGING_SIGN),
    SPRUCE_HANGING_SIGN(Blocks.SPRUCE_HANGING_SIGN),
    ...
    JUNGLE_HANGING_SIGN(Blocks.JUNGLE_HANGING_SIGN),
    DARK_OAK_HANGING_SIGN(Blocks.DARK_OAK_HANGING_SIGN),
    CRIMSON_HANGING_SIGN(Blocks.CRIMSON_HANGING_SIGN),
    WARPED_HANGING_SIGN(Blocks.WARPED_HANGING_SIGN),
    MANGROVE_HANGING_SIGN(Blocks.MANGROVE_HANGING_SIGN),
    BAMBOO_HANGING_SIGN(Blocks.BAMBOO_HANGING_SIGN),
    OAK_WALL_HANGING_SIGN(Blocks.OAK_WALL_HANGING_SIGN),
    SPRUCE_WALL_HANGING_SIGN(Blocks.SPRUCE_WALL_HANGING_SIGN),
    BIRCH_WALL_HANGING_SIGN(Blocks.BIRCH_WALL_HANGING_SIGN),
    ACACIA_WALL_HANGING_SIGN(Blocks.ACACIA_WALL_HANGING_SIGN),
    CHERRY_WALL_HANGING_SIGN(Blocks.CHERRY_WALL_HANGING_SIGN),
    JUNGLE_WALL_HANGING_SIGN(Blocks.JUNGLE_WALL_HANGING_SIGN),
    DARK_OAK_WALL_HANGING_SIGN(Blocks.DARK_OAK_WALL_HANGING_SIGN),
    MANGROVE_WALL_HANGING_SIGN(Blocks.MANGROVE_WALL_HANGING_SIGN),
    CRIMSON_WALL_HANGING_SIGN(Blocks.CRIMSON_WALL_HANGING_SIGN),
    WARPED_WALL_HANGING_SIGN(Blocks.WARPED_WALL_HANGING_SIGN),
    BAMBOO_WALL_HANGING_SIGN(Blocks.BAMBOO_WALL_HANGING_SIGN),
    LEVER(Blocks.LEVER),
    ...
    REDSTONE_WALL_TORCH(Blocks.REDSTONE_WALL_TORCH),
    ...
    SOUL_WALL_TORCH(Blocks.SOUL_WALL_TORCH),
    ...
    MELON(Blocks.MELON),
    ATTACHED_PUMPKIN_STEM(Blocks.ATTACHED_PUMPKIN_STEM),
    ATTACHED_MELON_STEM(Blocks.ATTACHED_MELON_STEM),
    ...
    WATER_CAULDRON(Blocks.WATER_CAULDRON),
    LAVA_CAULDRON(Blocks.LAVA_CAULDRON),
    POWDER_SNOW_CAULDRON(Blocks.POWDER_SNOW_CAULDRON),
    ...
    POTTED_TORCHFLOWER(Blocks.POTTED_TORCHFLOWER),
    POTTED_OAK_SAPLING(Blocks.POTTED_OAK_SAPLING),
    POTTED_SPRUCE_SAPLING(Blocks.POTTED_SPRUCE_SAPLING),
    POTTED_BIRCH_SAPLING(Blocks.POTTED_BIRCH_SAPLING),
    POTTED_JUNGLE_SAPLING(Blocks.POTTED_JUNGLE_SAPLING),
    POTTED_ACACIA_SAPLING(Blocks.POTTED_ACACIA_SAPLING),
    POTTED_CHERRY_SAPLING(Blocks.POTTED_CHERRY_SAPLING),
    POTTED_DARK_OAK_SAPLING(Blocks.POTTED_DARK_OAK_SAPLING),
    POTTED_MANGROVE_PROPAGULE(Blocks.POTTED_MANGROVE_PROPAGULE),
    POTTED_FERN(Blocks.POTTED_FERN),
    POTTED_DANDELION(Blocks.POTTED_DANDELION),
    POTTED_POPPY(Blocks.POTTED_POPPY),
    POTTED_BLUE_ORCHID(Blocks.POTTED_BLUE_ORCHID),
    POTTED_ALLIUM(Blocks.POTTED_ALLIUM),
    POTTED_AZURE_BLUET(Blocks.POTTED_AZURE_BLUET),
    POTTED_RED_TULIP(Blocks.POTTED_RED_TULIP),
    POTTED_ORANGE_TULIP(Blocks.POTTED_ORANGE_TULIP),
    POTTED_WHITE_TULIP(Blocks.POTTED_WHITE_TULIP),
    POTTED_PINK_TULIP(Blocks.POTTED_PINK_TULIP),
    POTTED_OXEYE_DAISY(Blocks.POTTED_OXEYE_DAISY),
    POTTED_CORNFLOWER(Blocks.POTTED_CORNFLOWER),
    POTTED_LILY_OF_THE_VALLEY(Blocks.POTTED_LILY_OF_THE_VALLEY),
    POTTED_WITHER_ROSE(Blocks.POTTED_WITHER_ROSE),
    POTTED_RED_MUSHROOM(Blocks.POTTED_RED_MUSHROOM),
    POTTED_BROWN_MUSHROOM(Blocks.POTTED_BROWN_MUSHROOM),
    POTTED_DEAD_BUSH(Blocks.POTTED_DEAD_BUSH),
    POTTED_CACTUS(Blocks.POTTED_CACTUS),
    ...
    SKELETON_SKULL(Blocks.SKELETON_SKULL),
    SKELETON_WALL_SKULL(Blocks.SKELETON_WALL_SKULL),
    WITHER_SKELETON_SKULL(Blocks.WITHER_SKELETON_SKULL),
    WITHER_SKELETON_WALL_SKULL(Blocks.WITHER_SKELETON_WALL_SKULL),
    ZOMBIE_HEAD(Blocks.ZOMBIE_HEAD),
    ZOMBIE_WALL_HEAD(Blocks.ZOMBIE_WALL_HEAD),
    PLAYER_HEAD(Blocks.PLAYER_HEAD),
    PLAYER_WALL_HEAD(Blocks.PLAYER_WALL_HEAD),
    CREEPER_HEAD(Blocks.CREEPER_HEAD),
    CREEPER_WALL_HEAD(Blocks.CREEPER_WALL_HEAD),
    DRAGON_HEAD(Blocks.DRAGON_HEAD),
    DRAGON_WALL_HEAD(Blocks.DRAGON_WALL_HEAD),
    PIGLIN_HEAD(Blocks.PIGLIN_HEAD),
    PIGLIN_WALL_HEAD(Blocks.PIGLIN_WALL_HEAD),
    ANVIL(Blocks.ANVIL),
    ...
    WHITE_CARPET(Blocks.WHITE_CARPET),
    ORANGE_CARPET(Blocks.ORANGE_CARPET),
    MAGENTA_CARPET(Blocks.MAGENTA_CARPET),
    LIGHT_BLUE_CARPET(Blocks.LIGHT_BLUE_CARPET),
    YELLOW_CARPET(Blocks.YELLOW_CARPET),
    LIME_CARPET(Blocks.LIME_CARPET),
    PINK_CARPET(Blocks.PINK_CARPET),
    GRAY_CARPET(Blocks.GRAY_CARPET),
    LIGHT_GRAY_CARPET(Blocks.LIGHT_GRAY_CARPET),
    CYAN_CARPET(Blocks.CYAN_CARPET),
    PURPLE_CARPET(Blocks.PURPLE_CARPET),
    BLUE_CARPET(Blocks.BLUE_CARPET),
    BROWN_CARPET(Blocks.BROWN_CARPET),
    GREEN_CARPET(Blocks.GREEN_CARPET),
    RED_CARPET(Blocks.RED_CARPET),
    BLACK_CARPET(Blocks.BLACK_CARPET),
    ...
    WHITE_BANNER(Blocks.WHITE_BANNER),
    ORANGE_BANNER(Blocks.ORANGE_BANNER),
    MAGENTA_BANNER(Blocks.MAGENTA_BANNER),
    LIGHT_BLUE_BANNER(Blocks.LIGHT_BLUE_BANNER),
    YELLOW_BANNER(Blocks.YELLOW_BANNER),
    LIME_BANNER(Blocks.LIME_BANNER),
    PINK_BANNER(Blocks.PINK_BANNER),
    GRAY_BANNER(Blocks.GRAY_BANNER),
    LIGHT_GRAY_BANNER(Blocks.LIGHT_GRAY_BANNER),
    CYAN_BANNER(Blocks.CYAN_BANNER),
    PURPLE_BANNER(Blocks.PURPLE_BANNER),
    BLUE_BANNER(Blocks.BLUE_BANNER),
    BROWN_BANNER(Blocks.BROWN_BANNER),
    GREEN_BANNER(Blocks.GREEN_BANNER),
    RED_BANNER(Blocks.RED_BANNER),
    BLACK_BANNER(Blocks.BLACK_BANNER),
    WHITE_WALL_BANNER(Blocks.WHITE_WALL_BANNER),
    ORANGE_WALL_BANNER(Blocks.ORANGE_WALL_BANNER),
    MAGENTA_WALL_BANNER(Blocks.MAGENTA_WALL_BANNER),
    LIGHT_BLUE_WALL_BANNER(Blocks.LIGHT_BLUE_WALL_BANNER),
    YELLOW_WALL_BANNER(Blocks.YELLOW_WALL_BANNER),
    LIME_WALL_BANNER(Blocks.LIME_WALL_BANNER),
    PINK_WALL_BANNER(Blocks.PINK_WALL_BANNER),
    GRAY_WALL_BANNER(Blocks.GRAY_WALL_BANNER),
    LIGHT_GRAY_WALL_BANNER(Blocks.LIGHT_GRAY_WALL_BANNER),
    CYAN_WALL_BANNER(Blocks.CYAN_WALL_BANNER),
    PURPLE_WALL_BANNER(Blocks.PURPLE_WALL_BANNER),
    BLUE_WALL_BANNER(Blocks.BLUE_WALL_BANNER),
    BROWN_WALL_BANNER(Blocks.BROWN_WALL_BANNER),
    GREEN_WALL_BANNER(Blocks.GREEN_WALL_BANNER),
    RED_WALL_BANNER(Blocks.RED_WALL_BANNER),
    BLACK_WALL_BANNER(Blocks.BLACK_WALL_BANNER),
    ...
    CUT_SANDSTONE_SLAB(Blocks.CUT_SANDSTONE_SLAB),
    ...
    REPEATING_COMMAND_BLOCK(Blocks.REPEATING_COMMAND_BLOCK),
    CHAIN_COMMAND_BLOCK(Blocks.CHAIN_COMMAND_BLOCK),
    FROSTED_ICE(Blocks.FROSTED_ICE),
    ...
    WHITE_SHULKER_BOX(Blocks.WHITE_SHULKER_BOX),
    ORANGE_SHULKER_BOX(Blocks.ORANGE_SHULKER_BOX),
    MAGENTA_SHULKER_BOX(Blocks.MAGENTA_SHULKER_BOX),
    LIGHT_BLUE_SHULKER_BOX(Blocks.LIGHT_BLUE_SHULKER_BOX),
    YELLOW_SHULKER_BOX(Blocks.YELLOW_SHULKER_BOX),
    LIME_SHULKER_BOX(Blocks.LIME_SHULKER_BOX),
    PINK_SHULKER_BOX(Blocks.PINK_SHULKER_BOX),
    GRAY_SHULKER_BOX(Blocks.GRAY_SHULKER_BOX),
    LIGHT_GRAY_SHULKER_BOX(Blocks.LIGHT_GRAY_SHULKER_BOX),
    CYAN_SHULKER_BOX(Blocks.CYAN_SHULKER_BOX),
    PURPLE_SHULKER_BOX(Blocks.PURPLE_SHULKER_BOX),
    BLUE_SHULKER_BOX(Blocks.BLUE_SHULKER_BOX),
    BROWN_SHULKER_BOX(Blocks.BROWN_SHULKER_BOX),
    GREEN_SHULKER_BOX(Blocks.GREEN_SHULKER_BOX),
    RED_SHULKER_BOX(Blocks.RED_SHULKER_BOX),
    BLACK_SHULKER_BOX(Blocks.BLACK_SHULKER_BOX),
    ...
    DEAD_TUBE_CORAL_FAN(Blocks.DEAD_TUBE_CORAL_FAN),
    DEAD_BRAIN_CORAL_FAN(Blocks.DEAD_BRAIN_CORAL_FAN),
    DEAD_BUBBLE_CORAL_FAN(Blocks.DEAD_BUBBLE_CORAL_FAN),
    DEAD_FIRE_CORAL_FAN(Blocks.DEAD_FIRE_CORAL_FAN),
    DEAD_HORN_CORAL_FAN(Blocks.DEAD_HORN_CORAL_FAN),
    TUBE_CORAL_FAN(Blocks.TUBE_CORAL_FAN),
    BRAIN_CORAL_FAN(Blocks.BRAIN_CORAL_FAN),
    BUBBLE_CORAL_FAN(Blocks.BUBBLE_CORAL_FAN),
    FIRE_CORAL_FAN(Blocks.FIRE_CORAL_FAN),
    HORN_CORAL_FAN(Blocks.HORN_CORAL_FAN),
    DEAD_TUBE_CORAL_WALL_FAN(Blocks.DEAD_TUBE_CORAL_WALL_FAN),
    DEAD_BRAIN_CORAL_WALL_FAN(Blocks.DEAD_BRAIN_CORAL_WALL_FAN),
    DEAD_BUBBLE_CORAL_WALL_FAN(Blocks.DEAD_BUBBLE_CORAL_WALL_FAN),
    DEAD_FIRE_CORAL_WALL_FAN(Blocks.DEAD_FIRE_CORAL_WALL_FAN),
    DEAD_HORN_CORAL_WALL_FAN(Blocks.DEAD_HORN_CORAL_WALL_FAN),
    TUBE_CORAL_WALL_FAN(Blocks.TUBE_CORAL_WALL_FAN),
    BRAIN_CORAL_WALL_FAN(Blocks.BRAIN_CORAL_WALL_FAN),
    BUBBLE_CORAL_WALL_FAN(Blocks.BUBBLE_CORAL_WALL_FAN),
    FIRE_CORAL_WALL_FAN(Blocks.FIRE_CORAL_WALL_FAN),
    HORN_CORAL_WALL_FAN(Blocks.HORN_CORAL_WALL_FAN),
    ...
    POTTED_BAMBOO(Blocks.POTTED_BAMBOO),
    VOID_AIR(Blocks.VOID_AIR),
    CAVE_AIR(Blocks.CAVE_AIR),
    BUBBLE_COLUMN(Blocks.BUBBLE_COLUMN),
    ...
    BLAST_FURNACE(Blocks.BLAST_FURNACE),
    ...
    WEEPING_VINES_PLANT(Blocks.WEEPING_VINES_PLANT),
    TWISTING_VINES(Blocks.TWISTING_VINES),
    TWISTING_VINES_PLANT(Blocks.TWISTING_VINES_PLANT),
    ...
    CRIMSON_SIGN(Blocks.CRIMSON_SIGN),
    WARPED_SIGN(Blocks.WARPED_SIGN),
    CRIMSON_WALL_SIGN(Blocks.CRIMSON_WALL_SIGN),
    WARPED_WALL_SIGN(Blocks.WARPED_WALL_SIGN),
    STRUCTURE_BLOCK(Blocks.STRUCTURE_BLOCK),
    JIGSAW(Blocks.JIGSAW),
    ...
    POTTED_CRIMSON_FUNGUS(Blocks.POTTED_CRIMSON_FUNGUS),
    POTTED_WARPED_FUNGUS(Blocks.POTTED_WARPED_FUNGUS),
    POTTED_CRIMSON_ROOTS(Blocks.POTTED_CRIMSON_ROOTS),
    POTTED_WARPED_ROOTS(Blocks.POTTED_WARPED_ROOTS),
    ...
    CANDLE_CAKE(Blocks.CANDLE_CAKE),
    WHITE_CANDLE_CAKE(Blocks.WHITE_CANDLE_CAKE),
    ORANGE_CANDLE_CAKE(Blocks.ORANGE_CANDLE_CAKE),
    MAGENTA_CANDLE_CAKE(Blocks.MAGENTA_CANDLE_CAKE),
    LIGHT_BLUE_CANDLE_CAKE(Blocks.LIGHT_BLUE_CANDLE_CAKE),
    YELLOW_CANDLE_CAKE(Blocks.YELLOW_CANDLE_CAKE),
    LIME_CANDLE_CAKE(Blocks.LIME_CANDLE_CAKE),
    PINK_CANDLE_CAKE(Blocks.PINK_CANDLE_CAKE),
    GRAY_CANDLE_CAKE(Blocks.GRAY_CANDLE_CAKE),
    LIGHT_GRAY_CANDLE_CAKE(Blocks.LIGHT_GRAY_CANDLE_CAKE),
    CYAN_CANDLE_CAKE(Blocks.CYAN_CANDLE_CAKE),
    PURPLE_CANDLE_CAKE(Blocks.PURPLE_CANDLE_CAKE),
    BLUE_CANDLE_CAKE(Blocks.BLUE_CANDLE_CAKE),
    BROWN_CANDLE_CAKE(Blocks.BROWN_CANDLE_CAKE),
    GREEN_CANDLE_CAKE(Blocks.GREEN_CANDLE_CAKE),
    RED_CANDLE_CAKE(Blocks.RED_CANDLE_CAKE),
    BLACK_CANDLE_CAKE(Blocks.BLACK_CANDLE_CAKE),
    ...
    CAVE_VINES(Blocks.CAVE_VINES),
    CAVE_VINES_PLANT(Blocks.CAVE_VINES_PLANT),
    ...
    BIG_DRIPLEAF_STEM(Blocks.BIG_DRIPLEAF_STEM),
    ...
    POTTED_AZALEA(Blocks.POTTED_AZALEA),
    POTTED_FLOWERING_AZALEA(Blocks.POTTED_FLOWERING_AZALEA),
    ...
    FROGSPAWN(Blocks.FROGSPAWN),
    REINFORCED_DEEPSLATE(Blocks.REINFORCED_DEEPSLATE),
    DECORATED_POT(Blocks.DECORATED_POT);
